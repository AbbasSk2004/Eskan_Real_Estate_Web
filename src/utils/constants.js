// PROPERTY_TYPES / PROPERTY_STATUS removed — single source of truth:
...
// GOVERNORATES / CITIES removed — single source of truth:
// src/constants/lebanonLocations.js
...
export const API_ENDPOINTS = {
  storage: process.env.NEXT_PUBLIC_STORAGE_URL || 'http://localhost:3001/storage'
};
